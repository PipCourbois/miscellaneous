...
-- optimus job can be found here: https://optimus.groupondev.com/#/jobs/edit/48491
...
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_train_pop_intl  purge;
--create table grp_gdoop_clv_db.eb_pip_deact_train_pop_intl
--(
-- brand string
--, consumer_id string
--, user_key string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_train_pop_intl
...
( 
              ...
              WHERE a.record_date = add_months( date_sub('${dateparam1}',1),-12)
...
analyze table grp_gdoop_clv_db.eb_pip_deact_train_pop_intl  partition(record_date = '${dateparam1}') compute statistics;
ALTER TABLE grp_gdoop_clv_db.eb_pip_deact_train_pop_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_temp_intl   purge;
----CREATE table grp_gdoop_clv_db.eb_pip_deact_train_pop  
--create table grp_gdoop_clv_db.eb_pip_deact_temp_intl  
--(
--         consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_temp_intl
partition (record_date = '${dateparam1}')
select 
         consumer_id
...
DISTRIBUTE BY consumer_id SORT BY consumer_id;analyze table grp_gdoop_clv_db.eb_pip_deact_temp_intl  partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_temp_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
------
--
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_response_intl  purge;
--
--create table select grp_gdoop_clv_db.eb_pip_deact_response_intl 
--(
--consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_response_intl  
partition (record_date = '${dateparam1}')
select 
    consumer_id
...
group by consumer_id , user_brand_affiliation;analyze table grp_gdoop_clv_db.eb_pip_deact_response_intl  partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_response_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_cookie_map1_intl  purge;
--
--create table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_intl
--(
--  consumer_id string
--	, bcookie string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_intl  
partition (record_date = '${dateparam1}')
...
(
    select 
        *
    from  grp_gdoop_clv_db.eb_pip_deact_train_pop_intl 
...
group by p.consumer_id, m.bcookie;analyze table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_intl  partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_cookie_map2_intl  purge;
--create table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_intl
--(
--  consumer_id string
--	, bcookie string
--	, last_cookie_date string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_intl
partition (record_date = '${dateparam1}')
SELECT 
	p.consumer_id
	,ords.bcookie
...
group by p.consumer_id,ords.bcookie;analyze table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_intl  partition (record_date = '${dateparam1}') compute statistics;-- union
alter table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');


------
--step 6
------
--create table grp_gdoop_clv_db.eb_pip_deact_cookie_map_intl
--(
--consumer_id string
--, bcookie string
--, last_cookie_date string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_cookie_map_intl 
partition (record_date = '${dateparam1}')
select 
	consumer_id
	, bcookie
...
(
	select 
		...
		, bcookie
		, last_cookie_date
	from grp_gdoop_clv_db.eb_pip_deact_cookie_map1_intl
	where record_date = '${dateparam1}'	
	union all
	select 
		consumer_id
		, bcookie
		, last_cookie_date
	from grp_gdoop_clv_db.eb_pip_deact_cookie_map2_intl
	where record_Date = '${dateparam1}'
) a
group by consumer_id, bcookie;analyze table grp_gdoop_clv_db.eb_pip_deact_cookie_map_intl  partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_cookie_map_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');

------
--step 7
------
--
--CREATE table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_intl
--(
--	cookie_b string
--	 , event_date string
--	 , visit_freq_90d int
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_intl  
partition (record_date = '${dateparam1}')
...
select 
  ...
  group by cookie_b;analyze table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_intl  partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');


-----
--step 8
--------
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_engagement_features_intl   purge;
--create table grp_gdoop_clv_db.eb_pip_deact_engagement_features_intl
--(
--consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_engagement_features_intl
partition(record_date = '${dateparam1}')
...
from 
(
select * from grp_gdoop_clv_db.eb_pip_deact_cookie_map_intl  where record_date = '${dateparam1}' ) p
join 
(
select * from grp_gdoop_clv_db.eb_pip_deact_engagement_temp_intl  where record_date = '${dateparam1}' ) sf
on p.bcookie = sf.cookie_b
group by p.consumer_id;analyze table grp_gdoop_clv_db.eb_pip_deact_engagement_features_intl  partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_engagement_features_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--drop table if exists grp_gdoop_clv_db.eb_pip_consumer_lt_orders_intl  purge;
--create table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_intl
--(
--consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_intl  
partition(record_date = '${dateparam1}')
select 
  consumer_id
...
group by consumer_id;analyze table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_intl  partition(record_date = '${dateparam1}')  compute statistics;alter table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--drop table if exists grp_gdoop_clv_db.deact_email_metrics_intl ;-- explain
--create table grp_gdoop_clv_db.deact_email_metrics_intl
--(
--consumer_id string 
--, send_recency string
--, sends_7d int
...
insert overwrite table grp_gdoop_clv_db.deact_email_metrics_intl 
partition (record_date = '${dateparam1}')
Select
        pop.consumer_id
...
join  
(
select * from grp_gdoop_clv_db.eb_pip_deact_train_pop_intl  where record_date = '${dateparam1}') pop
...
group by  pop.consumer_id;analyze table grp_gdoop_clv_db.deact_email_metrics_intl  partition (record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.deact_email_metrics_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_all_features_intl ;
--create table grp_gdoop_clv_db.eb_pip_deact_all_features_intl
--(
--     brand string
--    , consumer_id string
--    , data_set string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_all_features_intl  
partition(record_date = '${dateparam1}')
select
    pop.brand
    , pop.consumer_id
...
from 
(
    select *, record_date as training_date from grp_gdoop_clv_db.eb_pip_deact_train_pop_intl  where record_date = '${dateparam1}') pop

left outer join 
( select * from grp_gdoop_clv_db.eb_pip_deact_response_intl where record_date = '${dateparam1}') r
  on  pop.consumer_id = r.consumer_id

left outer join 
(
select * from grp_gdoop_clv_db.eb_pip_deact_temp_intl  where record_date = '${dateparam1}') t
  on pop.consumer_id = t.consumer_id

left outer join 
(select * from grp_gdoop_clv_db.eb_pip_deact_engagement_features_intl  where record_date = '${dateparam1}') ef
  on pop.consumer_id = ef.consumer_id
  
left outer join 
(select * from grp_gdoop_clv_db.eb_pip_consumer_lt_orders_intl  where record_date = '${dateparam1}') lt
  on pop.consumer_id = lt.consumer_id
  
left outer join 
( select * from grp_gdoop_clv_db.deact_email_metrics_intl  where record_date = '${dateparam1}') email
  on pop.consumer_id = email.consumer_id

DISTRIBUTE BY consumer_id SORT BY consumer_id;analyze table grp_gdoop_clv_db.eb_pip_deact_all_features_intl  partition (record_date = '${dateparam1}') compute statistics;analyze table grp_gdoop_clv_db.eb_pip_deact_all_features_intl  partition (record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_all_features_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');


------
--step 12
------
--create table grp_gdoop_clv_db.eb_pip_deact_training_intl
--(
--  brand string
--    , consumer_id string
--    , data_set string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_training_intl 
partition (record_date = '${dateparam1}')
...
select 
    ...
    , unsubscription_30d
from grp_gdoop_clv_db.eb_pip_deact_all_features_intl
where data_set = 'training'
and record_date = '${dateparam1}'

DISTRIBUTE BY consumer_id SORT BY consumer_id;

analyze table grp_gdoop_clv_db.eb_pip_deact_training_intl  partition (record_date = '${dateparam1}') compute statistics;
alter table grp_gdoop_clv_db.eb_pip_deact_training_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--create table grp_gdoop_clv_db.eb_pip_deact_validation_intl  
--(
--  brand string
--    , consumer_id string
--    , data_set string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_validation_intl 
partition (record_date = '${dateparam1}')
select 
  brand
    , consumer_id 
...
DISTRIBUTE BY consumer_id SORT BY consumer_id;
analyze table grp_gdoop_clv_db.eb_pip_deact_validation_intl  partition (record_date = '${dateparam1}') compute statistics;

alter table grp_gdoop_clv_db.eb_pip_deact_validation_intl  DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');

select * From grp_gdoop_clv_db.eb_pip_deact_validation_intl;
