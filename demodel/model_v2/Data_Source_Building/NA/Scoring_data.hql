--optimus job can be found here: https://optimus.groupondev.com/#/jobs/edit/47519
--please note that sevendaysago is set to current_date +358 and dateparam1 = current_date + 364
...
-----
--
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring purge;
--create table grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring 
--(
-- brand string
--, consumer_id string
--, user_key string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring 
...
analyze table grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring partition(record_date = '${dateparam1}') compute statistics;ALTER TABLE grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_temp_scoring  purge;
----CREATE table grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring 
--create table grp_gdoop_clv_db.eb_pip_deact_temp_scoring  
--(
--         consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_temp_scoring
partition (record_date = '${dateparam1}')
select 
         consumer_id
...
DISTRIBUTE BY consumer_id SORT BY consumer_id;analyze table grp_gdoop_clv_db.eb_pip_deact_temp_scoring partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_temp_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');

------
--step 3
------

--drop table if exists grp_gdoop_clv_db.eb_pip_deact_response_scoring purge;
--
--create table grp_gdoop_clv_db.eb_pip_deact_response_scoring
--(
--consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_response_scoring  
partition (record_date = '${dateparam1}')
select 
    consumer_id
...
group by consumer_id , user_brand_affiliation;analyze table grp_gdoop_clv_db.eb_pip_deact_response_scoring partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_response_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_cookie_map1_scoring purge;
--
--create table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_scoring
--(
--  consumer_id string
--	, bcookie string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_scoring 
partition (record_date = '${dateparam1}')
...
(
    select 
        *
    from  grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring
...
group by p.consumer_id, m.bcookie;analyze table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_scoring partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_cookie_map1_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
------
--
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_cookie_map2_scoring purge;
--create table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_scoring
--(
--  consumer_id string
--	, bcookie string
--	, last_cookie_date string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_scoring 
partition (record_date = '${dateparam1}')
SELECT 
	p.consumer_id
	,ords.bcookie
...
group by p.consumer_id,ords.bcookie;analyze table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_scoring partition (record_date = '${dateparam1}') compute statistics;-- union
alter table grp_gdoop_clv_db.eb_pip_deact_cookie_map2_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');

------
--step 6
------
--create table grp_gdoop_clv_db.eb_pip_deact_cookie_map_scoring 
--(
--consumer_id string
--, bcookie string
--, last_cookie_date string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_cookie_map_scoring 
partition (record_date = '${dateparam1}')
select 
	consumer_id
	, bcookie
...
(
	select 
		...
		, bcookie
		, last_cookie_date
	from grp_gdoop_clv_db.eb_pip_deact_cookie_map1_scoring
	where record_date = '${dateparam1}'	
	union all
	select 
		consumer_id
		, bcookie
		, last_cookie_date
	from grp_gdoop_clv_db.eb_pip_deact_cookie_map2_scoring
	where record_Date = '${dateparam1}'
) a
group by consumer_id, bcookie;analyze table grp_gdoop_clv_db.eb_pip_deact_cookie_map_scoring partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_cookie_map_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
------
--
--CREATE table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_scoring 
--(
--	cookie_b string
--	 , event_date string
--	 , visit_freq_90d int
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_scoring 
partition (record_date = '${dateparam1}')
...
select 
  ...
  group by cookie_b;analyze table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_scoring partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_engagement_temp_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
  
-----
--step 8
--------
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_engagement_features_scoring  purge;
--create table grp_gdoop_clv_db.eb_pip_deact_engagement_features_scoring 
--(
--consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_engagement_features_scoring 
partition(record_date = '${dateparam1}')
...
from 
(
select * from grp_gdoop_clv_db.eb_pip_deact_cookie_map_scoring where record_date = '${dateparam1}' ) p
join 
(
select * from grp_gdoop_clv_db.eb_pip_deact_engagement_temp_scoring where record_date = '${dateparam1}' ) sf
on p.bcookie = sf.cookie_b
group by p.consumer_id;analyze table grp_gdoop_clv_db.eb_pip_deact_engagement_features_scoring partition(record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_engagement_features_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--drop table if exists grp_gdoop_clv_db.eb_pip_consumer_lt_orders_scoring purge;
--create table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_scoring  
--(
--consumer_id string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_scoring  
partition(record_date = '${dateparam1}')
select 
  consumer_id
...
group by consumer_id;analyze table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_scoring partition(record_date = '${dateparam1}')  compute statistics;alter table grp_gdoop_clv_db.eb_pip_consumer_lt_orders_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--drop table if exists grp_gdoop_clv_db.deact_email_metrics_scoring;-- explain
--create table grp_gdoop_clv_db.deact_email_metrics_scoring
--(
--consumer_id string 
--, send_recency string
--, sends_7d int
...
insert overwrite table grp_gdoop_clv_db.deact_email_metrics_scoring 
partition (record_date = '${dateparam1}')
Select
        pop.consumer_id
...
join  
(
select * from grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring where record_date = '${dateparam1}') pop
...
group by  pop.consumer_id;analyze table grp_gdoop_clv_db.deact_email_metrics_scoring partition (record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.deact_email_metrics_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--drop table if exists grp_gdoop_clv_db.eb_pip_deact_all_features_scoring;
--create table grp_gdoop_clv_db.eb_pip_deact_all_features_scoring 
--(
--     brand string
--    , consumer_id string
--    , data_set string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_all_features_scoring 
partition(record_date = '${dateparam1}')
select
    pop.brand
    , pop.consumer_id
...
from 
(
    select *, record_date as training_date from grp_gdoop_clv_db.eb_pip_deact_train_pop_scoring where record_date = '${dateparam1}') pop

left outer join 
( select * from grp_gdoop_clv_db.eb_pip_deact_response_scoring where record_date = '${dateparam1}') r
  on  pop.consumer_id = r.consumer_id

left outer join 
(
select * from grp_gdoop_clv_db.eb_pip_deact_temp_scoring where record_date = '${dateparam1}') t
  on pop.consumer_id = t.consumer_id

left outer join 
(select * from grp_gdoop_clv_db.eb_pip_deact_engagement_features_scoring where record_date = '${dateparam1}') ef
  on pop.consumer_id = ef.consumer_id
  
left outer join 
(select * from grp_gdoop_clv_db.eb_pip_consumer_lt_orders_scoring where record_date = '${dateparam1}') lt
  on pop.consumer_id = lt.consumer_id
  
left outer join 
( select * from grp_gdoop_clv_db.deact_email_metrics_scoring where record_date = '${dateparam1}') email
  on pop.consumer_id = email.consumer_id

DISTRIBUTE BY consumer_id SORT BY consumer_id;analyze table grp_gdoop_clv_db.eb_pip_deact_all_features_scoring partition (record_date = '${dateparam1}') compute statistics;analyze table grp_gdoop_clv_db.eb_pip_deact_all_features_scoring partition (record_date = '${dateparam1}') compute statistics;alter table grp_gdoop_clv_db.eb_pip_deact_all_features_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');


------
--step 12
------
--create table grp_gdoop_clv_db.eb_pip_deact_training_scoring
--(
--  brand string
--    , consumer_id string
--    , data_set string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_training_scoring 
partition (record_date = '${dateparam1}')
...
analyze table grp_gdoop_clv_db.eb_pip_deact_training_scoring partition (record_date = '${dateparam1}') compute statistics;
alter table grp_gdoop_clv_db.eb_pip_deact_training_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
...
--
--create table grp_gdoop_clv_db.eb_pip_deact_validation_scoring 
--(
--  brand string
--    , consumer_id string
--    , data_set string
...
insert overwrite table grp_gdoop_clv_db.eb_pip_deact_validation_scoring
partition (record_date = '${dateparam1}')
select 
  brand
    , consumer_id 
...
DISTRIBUTE BY consumer_id SORT BY consumer_id;
analyze table grp_gdoop_clv_db.eb_pip_deact_validation_scoring partition (record_date = '${dateparam1}') compute statistics;

alter table grp_gdoop_clv_db.eb_pip_deact_validation_scoring DROP IF EXISTS PARTITION(record_date <= '${sevendaysago}');
